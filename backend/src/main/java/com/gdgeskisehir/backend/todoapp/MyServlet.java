...
package com.gdgeskisehir.backend.todoapp;
...
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger("com.gdgeskisehir.backend.todoapp.MyServlet");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        Firebase firebase = new Firebase(Constants.FIREBASE_ENDPOINT + "todoItems");
        firebase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("nagger@" + Constants.APP_ID + ".appspotmail.com",
                            "Todo Nagger"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress(Constants.MAIL_TO, "Recipient"));
